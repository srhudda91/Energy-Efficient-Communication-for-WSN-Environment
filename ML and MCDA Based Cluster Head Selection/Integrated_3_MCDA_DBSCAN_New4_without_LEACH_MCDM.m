...
legend({'RCA Method', 'SRA Method', 'RRA Method', 'DBSCAN', 'HEED', 'LEACH-C', 'LEACH', 'DDMPEA-ANUM', 'DWEHC', 'FOHCA'}, 'Location', 'BestOutside');
hold off;
...
legend(flip({'RCA Method', 'SRA Method', 'RRA Method', 'DBSCAN', 'HEED', 'LEACH-C', 'LEACH', 'DDMPEA-ANUM', 'DWEHC', 'FOHCA'}), 'Location', 'BestOutside');
hold off;
